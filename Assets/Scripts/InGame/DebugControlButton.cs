                ...
                LeanTween.delayedCall(gameObject, 3, () =>
                {
                    switch (_actionType)
                    {
                        ...
                        case ActionType.UnlockLevels:
                            ...
                            PlayerPrefsHandler.SetLevelStars(7, 12);
                            PlayerPrefsHandler.SetLevelStars(8, 15);
                            PlayerPrefsHandler.SetLevelStars(9, 15);
                            PlayerPrefsHandler.SetLevelStars(10, 3);
                            PlayerPrefsHandler.LastLevelIndex = 10;
                            UnityEngine.SceneManagement.SceneManager.LoadScene(0);
